...
class UpdatePipelineRequest(BaseModel):
    ...
    status: Optional[StrictStr] = Field(None, description="Used to change a pipeline from inactive to active or vice-versa.  Moving from active to inactive can also be achieve by `DELETE`ing the pipeline resource. ")
    __properties = ["description", "steps", "status"]

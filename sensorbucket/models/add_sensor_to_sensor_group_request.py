...
class AddSensorToSensorGroupRequest(BaseModel):
    """
    AddSensorToSensorGroupRequest
    """ # noqa: E501
    sensor_id: Optional[StrictInt] = Field(default=None, description="id of the sensor to add")
    __properties: ClassVar[List[str]] = ["sensor_id"]
